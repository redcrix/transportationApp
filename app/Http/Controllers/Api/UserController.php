...
/** 
    ...
    {
        $users=User::all();
        return  response()->json(['code'=>$this->successStatus,'message'=>'success','error' => false,'data' => $users]); 
    ...
    public function update(Request $request)
        ...
        return  response()->json(['code'=>$this->successStatus,'message'=>'success','error' => false,'data' => $user]); 
...
if ($validator->fails()) { 
            ...
            return response()->json(['code'=>401,'message'=>$validator->errors(),'error' => true]);            
        }
    $input=$request->all();
     try {
    User::findorfail($input['user_id'])->delete();
        ...
        return response()->json(['code'=>401,'message'=>'No user found with id '.$input['user_id'].'','error' => true]);
        //return back()->withError($exception->getMessage())->withInput();
    }
    return  response()->json(['code'=>$this->successStatus,'message'=>'user successfully removed ','error' => false]); 
   // return $user->delete();
}
